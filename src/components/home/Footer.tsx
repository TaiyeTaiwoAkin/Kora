    ...
    <footer className="bg-charcoal py-16">
      <div className="mx-auto max-w-6xl px-6">
        <motion.div
          ...
          className="flex flex-col items-center gap-10 sm:flex-row sm:items-start sm:justify-between"
        >
          {/* Brand */}
          <div className="text-center sm:text-left">
            <h3 className="font-heading text-2xl font-bold text-white">Kora</h3>
            <p className="mt-2 max-w-xs font-body text-sm text-white/60">
              Premium African fashion, curated for the world.
            </p>
          </div>
